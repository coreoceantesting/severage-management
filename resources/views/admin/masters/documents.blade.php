<x-admin.layout>
    <x-slot name="title">Documents Masters</x-slot>
    <x-slot name="heading">Documents Masters</x-slot>
                                    ...
                                    @foreach ($documents as $index => $document)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button class="btn text-danger rem-element px-2 py-1" title="Delete document" data-id="{{ $document->id }}"><i data-feather="trash-2"></i> </button>
                                            </td>
                                        </tr>
                                    @endforeach
                            </table>
